...
% Translate y outputs to matriz form Y : 10x5000
...
%Jreg1 = lambda/(2*m)*( sum(sum(Theta1.^2) - sum(Theta1(1,:).^2)) +...
...
Theta1_grad = gradient1./m;
Theta2_grad = gradient2./m;
